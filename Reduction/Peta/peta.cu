...
int main(int argc, char **argv)
{
    ...
    while (elements_remaining > 1)
    {
        ...
        device_vector_data = device_vector_result;
        device_vector_result = temp;
    }

    int result = 0;

    cudaMemcpy(&result, device_vector_data, sizeof(int), cudaMemcpyDeviceToHost);
